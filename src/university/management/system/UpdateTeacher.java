...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    public UpdateTeacher() {
        ...
        JLabel labelpesgel = new JLabel();
        labelpesgel.setBounds(600, 350, 150, 30);
        labelpesgel.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(labelpesgel);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                labelpesgel.setText(rs.getString("pesgel"));
